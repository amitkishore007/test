...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Blackdiamondcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"blackdiamondcointools.com", "46.101.84.45"},
 
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"blackdiamondcointools.com", "testnet-seed.blackdiamondcointools.com"},
