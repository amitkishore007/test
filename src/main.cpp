...
#if defined(NDEBUG)
# error "Blackdiamondcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5f2cc49fcd1d1dcf343dca698f383f74e2e92702f24654b9ba04fca0c09bb2b0");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Blackdiamondcoin: starting difficulty is 1 / 2^12
...
{
    // Blackdiamondcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 999999 * COIN;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 840000); // Blackdiamondcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan =  2 * 60; // Blackdiamondcoin: 2 minutes
static const int64 nTargetSpacing = 1 * 30; // Blackdiamondcoin: 0.5  minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Blackdiamondcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Blackdiamondcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5f2cc49fcd1d1dcf343dca698f383f74e2e92702f24654b9ba04fca0c09bb2b0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("124684710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1503736903;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1467455;
        ...
        assert(block.hashMerkleRoot == uint256("0xd4221e9989bf6ee350c8134aa8391dc2c8f6c14e0a8d3fc534efa96fb509bb82"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Blackdiamondcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BlackdiamondcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BlackdiamondcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BlackdiamondcoinMiner(CWallet *pwallet)
{
    printf("BlackdiamondcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("blackdiamondcoin-miner");
    ...
    try { loop {
        ...
        printf("Running BlackdiamondcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BlackdiamondcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BlackdiamondcoinMiner, pwallet));
}
